  ...
  return (
    <main className="animate-page-in overflow-x-hidden bg-slate-50 text-slate-900">
      <div className="relative isolate">
        ...
        <section className="relative mx-auto flex min-h-[calc(100vh-88px)] max-w-7xl flex-col justify-center px-6 pb-16 pt-8 lg:px-8 lg:pb-24">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8" id="how-it-works">
        <Reveal>
          <SectionHeading
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8" id="testimonials">
        <Reveal>
          <SectionHeading
      ...
      <section className="px-6 pb-16 pt-6 lg:px-8">
        <Reveal>
      ...
      <footer className="border-t border-slate-200/80 bg-white/80 px-6 py-10 backdrop-blur">
...
function HeroDashboardMockup() {
  return (
    <div className="relative mx-auto w-full max-w-[560px]">
      <div className="overflow-hidden rounded-[32px] border border-white/70 bg-white/90 p-3 shadow-[0_32px_90px_-35px_rgba(15,23,42,0.35)] backdrop-blur">
        <div className="rounded-[28px] border border-slate-200 bg-slate-950 p-3 shadow-inner">
          <div className="flex items-center gap-2 rounded-[22px] bg-slate-900 px-4 py-3">
            <span className="h-3 w-3 rounded-full bg-rose-400" />
            <span className="h-3 w-3 rounded-full bg-amber-400" />
            <span className="h-3 w-3 rounded-full bg-emerald-400" />
            <div className="ml-3 h-9 flex-1 rounded-full bg-white/5 px-4 py-2 text-sm text-slate-400">
              medihelp.app/dashboard
            </div>
          </div>

          <div className="mt-3 rounded-[24px] bg-white p-6 text-slate-900">
            <div className="flex flex-col gap-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-500">Good morning, Priya</p>
                  <p className="mt-1 text-2xl font-semibold tracking-tight">Your health overview</p>
                </div>
...
function AIInsightsPreview() {
  ...
  return (
    <div className="rounded-[32px] border border-white/10 bg-white/5 p-4 shadow-[0_28px_90px_-40px_rgba(2,6,23,0.85)] backdrop-blur">
      <div className="rounded-[28px] border border-white/10 bg-slate-900 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-semibold text-white">Today&apos;s care summary</p>
          </div>
        ...
        <div className="mt-6 rounded-[24px] border border-white/10 bg-white/[0.04] p-5">
          ...
          <p className="mt-5 min-h-[104px] text-lg leading-8 text-slate-200">
            {typedText}
